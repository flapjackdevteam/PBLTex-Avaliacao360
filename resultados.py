...
def tela_resultado_time_sprint(time):
    ...
    desenho_do_grafico_sprint1= dashboard_2.gerar_grafico_resultado_time(1, time)
    desenhar_grafico_na_aba(window['-CANVAS_SPRINT_1-'].TKCanvas, desenho_do_grafico_sprint1)

    desenho_do_grafico_sprint2= dashboard_2.gerar_grafico_resultado_time(2, time)
    desenhar_grafico_na_aba(window['-CANVAS_SPRINT_2-'].TKCanvas, desenho_do_grafico_sprint2)

    desenho_do_grafico_sprint3= dashboard_2.gerar_grafico_resultado_time(3, time)
    desenhar_grafico_na_aba(window['-CANVAS_SPRINT_3-'].TKCanvas, desenho_do_grafico_sprint3)

    desenho_do_grafico_sprint4= dashboard_2.gerar_grafico_resultado_time(4, time)
    desenhar_grafico_na_aba(window['-CANVAS_SPRINT_4-'].TKCanvas, desenho_do_grafico_sprint4)
...
def tela_resultado_turma_sprint(turma):
    ...
    desenho_do_grafico_sprint1= dashboard_2.gerar_grafico_resultado_turma(1, turma)
    desenhar_grafico_na_aba(window['-CANVAS_SPRINT_1-'].TKCanvas, desenho_do_grafico_sprint1)

    desenho_do_grafico_sprint2= dashboard_2.gerar_grafico_resultado_turma(2, turma)
    desenhar_grafico_na_aba(window['-CANVAS_SPRINT_2-'].TKCanvas, desenho_do_grafico_sprint2)

    desenho_do_grafico_sprint3= dashboard_2.gerar_grafico_resultado_turma(3, turma)
    desenhar_grafico_na_aba(window['-CANVAS_SPRINT_3-'].TKCanvas, desenho_do_grafico_sprint3)

    desenho_do_grafico_sprint4= dashboard_2.gerar_grafico_resultado_turma(4, turma)
    desenhar_grafico_na_aba(window['-CANVAS_SPRINT_4-'].TKCanvas, desenho_do_grafico_sprint4)
